...
public class Unit<V extends Comparable<? super V>> implements Comparable<Unit<V>> {
	...
	public void setParams(Map<ParamsName, V> params) throws NullPointerException {
		if (params == null)
			throw new NullPointerException("the input is null instead of Map");
		if (params.containsKey(null) || params.containsValue(null))
			throw new NullPointerException("Null containing entry detected");
